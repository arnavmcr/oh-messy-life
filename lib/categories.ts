...
export const CATEGORY_MAP: Record<string, CategoryConfig> = {
  ...
  projects: {
    label: 'Projects',
    accentColor: 'primary',
    tagline: 'things built in mumbai. not all of them finished.',
    postIts: [],
    subcategories: {},
  },
  mba: {
    label: 'MBA',
    accentColor: 'secondary',
    tagline: 'startups, strategy, doubt — notes from business school.',
    postIts: [],
    subcategories: {},
  },
  essays: {
    label: 'Essays',
    accentColor: 'tertiary',
    tagline: 'things i had to get out of my head.',
    postIts: [],
    subcategories: {},
  },
  music: {
